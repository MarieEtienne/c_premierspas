...
```{r le_monde_graph, eval = TRUE, echo = FALSE, out.width = '60%'}
# All defaults
...
```{r smockers, eval = TRUE, echo = FALSE, out.width = '60%'}
# All defaults
...
```{r gf, eval = TRUE, echo = FALSE, out.width = '60%'}
# All defaults
...
```{r jc, eval = TRUE, echo = FALSE, out.width = '60%'}
# All defaults
