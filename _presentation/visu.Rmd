...
```{r gg_save, eval = FALSE, echo = FALSE, message = FALSE, , out.width = '60%'}
gg <- penguins %>%
  ggplot() + 
  aes(x = bill_l) + 
  geom_histogram() 
...
```{r gg_save, eval = FALSE, echo = TRUE, message = FALSE, , out.width = '60%'}
```
...
```{r gg1_save, eval = FALSE, echo = FALSE, message = FALSE, , out.width = '60%'}
gg <- penguins %>% 
  ggplot() +
  aes( x= bill_l, y=bill_d) +
  geom_point() 
...
```{r gg1_save, eval = TRUE, echo = TRUE, message = FALSE, results='hide', out.width = '60%'}
```
...
```{r hist_color_stack, eval = FALSE, echo = TRUE, out.width = '60%'}
```
...
```{r hist_color_stack, eval = TRUE, echo = TRUE, out.width = '30%'}
```
...
```{r hist_color_diff, eval = FALSE, echo = FALSE, out.width = '30%'}
penguins %>%
  ggplot() + aes(x = bill_l, fill = species) + 
...
```{r scatter_wesanderson, eval = FALSE, echo = TRUE, out.width = '60%'}
```
...
```{r exo_relation_cor, eval =  FALSE, echo = with_sol, out.width = '60%'}
penguins %>% ggplot() +
  aes(x= bm, y = flip_l) + 
  geom_point() + 
...
```{r scatter_themelight, eval = FALSE, echo = TRUE, out.width = '60%'}
```
...
```{r scatter_thememinimal, eval = FALSE, echo = TRUE, out.width = '60%'}
```
...
```{r preset_theme, eval = TRUE, echo = FALSE, out.width = '50%'}
gg
```
...
```{r color_boxplot_3, eval = FALSE, echo = TRUE, out.width = '60%'}
```
