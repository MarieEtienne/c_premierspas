...
```{r simple_hist, eval = FALSE, echo = FALSE, out.width = '60%'}
penguins %>%
  ggplot() + 
  aes(x = bill_l) + 
  geom_histogram() 
...
```{r simple_hist_dens, eval = FALSE, echo = FALSE, out.width = '60%'}
penguins %>%
  ggplot() + 
  aes(x = bill_l) + 
  geom_histogram() +
...
```{r hist_color_stack, eval = FALSE, echo = FALSE, out.width = '60%'}
penguins %>%
...
```{r gg1_save, eval = TRUE, echo = TRUE, message = FALSE, , out.width = '60%'}
gg <- penguins %>% 
  ggplot() +
  aes( x= bill_l, y=bill_d) +
  geom_point() + 
...
```{r scatter_viridis, eval = FALSE, echo = FALSE, out.width = '60%'}
gg + 
...
```{r scatter_wesanderson, eval = FALSE, echo = FALSE, out.width = '60%'}
gg + 
...
```{r exo_relation_cor, eval =  TRUE, echo = with_sol, out.width = '60%'}
penguins %>% ggplot() +
...
```{r scatter_labels_gg, eval = TRUE, echo = TRUE, out.width = '60%'}
...
```{r scatter_labels, eval = FALSE, echo = FALSE, out.width = '60%'}
gg  +
...
```{r scatter_themelight, eval = FALSE, echo = FALSE, out.width = '60%'}
gg  +
  labs( x = 'Bill length in mm') +
  labs(y = 'Bill depth in mm') +
...
```{r scatter_thememinimal, eval = FALSE, echo = FALSE, out.width = '60%'}
...
```{r scatter_set_theme, eval = TRUE, echo = TRUE, out.width = '60%'}
gg <- gg + scale_color_manual(values = color_darj) +
...
```{r preset_theme, eval = TRUE, echo = FALSE, out.width = '60%'}
gg
```

---

```{r scatter_below, eval = FALSE, echo = FALSE, out.width = '60%'}
gg + 
...
```{r scatter_within, eval = TRUE, echo = TRUE, out.width = '60%'}
gg + 
...
```{r scatter_custom, eval = TRUE, echo = TRUE, out.width = '60%'}
...
```{r stat_info_lm, eval = FALSE, echo = FALSE, out.width = '60%'}
gg + 
...
```{r exo_relation_cor2, eval =  TRUE, echo = with_sol, out.width = '60%'}
penguins %>% ggplot() + 
  aes(x= bm, y = flip_l, col = as_factor(year) ) + 
...
```{r theme_setup, eval = FALSE, echo = FALSE, out.width = '60%'}
...
```{r theme_setup_2, eval = FALSE, echo = FALSE, out.width = '60%'}
...
```{r simple_hist_min, eval = FALSE, echo = FALSE, out.width = '60%'}
penguins %>%
...
```{r color_hist,   echo = TRUE, eval = FALSE, out.width = '60%'}
 penguins %>%  ...
```
...
```{r color_hist_cor_comp, eval = FALSE, echo = FALSE, out.width = '60%'}
penguins %>%
  ggplot() + aes(x = bill_l, fill = species) + geom_histogram() +
  labs( x = 'Bill length in mm') +
...
`r chunk_reveal("color_hist_cor_comp", break_type = "auto")`
...
```{r color_hist_facet, eval = FALSE, echo = FALSE, out.width = '60%'}
penguins %>%
...
```{r color_hist_dens_ex, eval = FALSE, echo = TRUE, out.width = '60%'}
...
```{r color_hist_dens_cor, eval = FALSE, echo = FALSE, out.width = '60%'}
...
```{r color_boxplot, eval = TRUE, echo = TRUE, out.width = '60%'}
...
```{r color_boxplot_2, eval = FALSE, echo = FALSE, out.width = '60%'}
 penguins %>%  ggplot() + aes(x = species,  y = bill_l) +
...
```{r color_boxplot_3, eval = FALSE, echo = FALSE, out.width = '60%'}
penguins %>%  ggplot() + aes(x = species,  y = bill_l) +
  geom_boxplot(alpha=0.5, aes( fill = species)) +
...
```{r color_boxplot_sup_sub, echo = TRUE, eval = TRUE, out.width = '60%'}
...
```{r ggpubr_p1, eval = TRUE, echo = TRUE, out.width = '60%'}
gg_p1 <- gg
gg_p1
``` 
...
```{r ggpubr_p2, eval = TRUE, echo = TRUE, out.width = '60%'}
gg_p2 <- penguins %>%
...
```{r ggpubr_p3, eval = TRUE, echo = TRUE, out.width = '60%'}
...
```{r ggpubr_p4, eval = TRUE, echo = TRUE, out.width = '60%'}
...
```{r ggpairs, eval = TRUE, echo = TRUE, out.width = '60%'}
...
```{r ggpairs_fancy, eval = TRUE, echo = TRUE, out.width = '60%'}
penguins %>% ggpairs(columns = c(1,3,4,5), mapping = aes(col = species),
...
```{r ani_final, eval = F, echo = T, out.width = '60%'}
library(gganimate)
gg  +
...
```{r refs, echo=FALSE, results="asis", eval = TRUE, cache = FALSE, out.width = '60%'}
