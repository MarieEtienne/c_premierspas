...
```{r le_monde_graph, eval = TRUE, echo = FALSE, out.height = '50%'}
# All defaults
...
```{r smockers, eval = TRUE, echo = FALSE, out.height = '50%'}
# All defaults
...
```{r gf, eval = TRUE, echo = FALSE, out.height = '50%'}
# All defaults
...
```{r jc, eval = TRUE, echo = FALSE, out.height = '50%'}
# All defaults
...
```{r color_hist_cor, eval = FALSE, echo = FALSE, out.width = '60%'}
penguins %>%
...
```{r ani_final, eval = T, echo = T, out.width = '60%'}
library(gganimate)
gg  +
