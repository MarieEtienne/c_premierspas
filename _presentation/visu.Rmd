...
# All defaults
knitr::include_graphics(file.path(course_img_dir,"images/smockers.png"))
```
...
# All defaults
knitr::include_graphics(file.path(course_img_dir,"images/corona_gf.png"))
```
...
# All defaults
knitr::include_graphics(file.path(course_img_dir,"images/corona_j_castex.png"))
```
