...
Le \texttt{tidyverse} est ensemble de packages développés pour {\it faciliter} la manipulation de données dans \R.

-  Installer le package \texttt{tidyverse}.

```{r, eval = FALSE}
install.packages("tidyverse")
```

D'après les créateurs  dans @r4ds
